...
public class ClientConfig {
  ...
  Jaxb2Marshaller jaxb2Marshaller() {
    ...
    String[] packagesToScan= {"com.codenotfound.types.flightsearch"};
    jaxb2Marshaller.setPackagesToScan(packagesToScan);
    jaxb2Marshaller.setPackagesToScan("com.codenotfound.types.flightsearch");
  ...
  uc.setDefaultUri("http://CG1148:9090/codenotfound/ws/flightsearch/wsdl/flightsearch.wsdl");
